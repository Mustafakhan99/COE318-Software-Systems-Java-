...
double rnum,inum;
  ...
  public ComplexNumber(double re, double im) {
    rnum=re;
    inum=im; //Initialize the instance variables
  }
  ...
  public double getReal() {
      return rnum;  //A stub: to be fixed
  }
  ...
  public double getImaginary() {
      return inum;  //A stub: to be fixed
  }
  ...
  public ComplexNumber negate() {
      return new ComplexNumber(-rnum,-inum); //A stub: to be fixed
  }
  ...
  public ComplexNumber add(ComplexNumber z) {
      return new ComplexNumber((rnum+z.rnum),(inum+z.inum));
  ...
  public ComplexNumber subtract(ComplexNumber z) {
      return new ComplexNumber((rnum-z.rnum),(inum-z.inum)) ; //A stub: to be fixed
  }
  ...
  public ComplexNumber multiply(ComplexNumber z) {
      return new ComplexNumber((rnum*z.rnum - inum*z.inum), (inum*z.rnum + rnum*z.inum));   //A stub: to be fixed
  }
  ...
  public ComplexNumber reciprocal() {
     return new ComplexNumber((rnum/(rnum*rnum + inum*inum)),(-inum/(rnum*rnum + inum*inum)));  //A stub: to be fixed
  }
  ...
  public ComplexNumber divide(ComplexNumber z) {
      ...
      ComplexNumber divided = new ComplexNumber(
              ((rnum*x + inum*y)/(x*x + y*y)),
              ((inum*x - rnum*y)/(x*x + y*y)));
